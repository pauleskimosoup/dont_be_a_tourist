...
tinyMCE.init({
    ...
    theme_advanced_buttons1:"bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,hr,styleselect,formatselect",
    theme_advanced_buttons2:"undo,redo,link,unlink,tmediaimage,pasteword,code",
